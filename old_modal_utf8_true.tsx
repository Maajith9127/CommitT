...
export const EventDetailModal = React.memo(function EventDetailModal() {
  ...
  // Failure modal state ΓÇö shown when verification returns a non-success result
  ...
  // ΓöÇΓöÇ Action Menu State ΓöÇΓöÇ
  ...
  const handleVerifyCondition = async (metricKey: string, evidence?: any) => {
    ...
    try {
      ...
      // ΓöÇΓöÇ SYNC LOCAL CACHE ΓöÇΓöÇ
      if (status === 'verified') {
        try {
      ...
      // If the result is NOT verified ΓåÆ show failure modal with the backend's reason
      if (status !== 'verified') {
        setFailureModal({
          visible: true,
          title: message,
  ...
  return (
    ...
    >
      ...
      {/* ΓöÇΓöÇ Delete Confirmation Modal ΓöÇΓöÇ */}
      <ConfirmationModal
      ...
      {/* ΓöÇΓöÇ Failure Reason Modal (overlays on top of the event modal) ΓöÇΓöÇ */}
      <ConfirmationModal
      ...
      {/* ΓöÇΓöÇ Waiver Action Modal ΓöÇΓöÇ */}
      <WaiverActionModal
      ...
      {/* ΓöÇΓöÇ Waiver Start Confirmation Modal ΓöÇΓöÇ */}
      <ConfirmationModal
      ...
      {/* ΓöÇΓöÇ Strict Mode Confirmation Modal ΓöÇΓöÇ */}
      <ConfirmationModal
