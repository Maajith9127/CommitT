...
_An overview of the APIs and utilities provided by Expo to develop native modules._
...
[Expo Modules API: Design considerations](https://docs.expo.dev/modules/design)
