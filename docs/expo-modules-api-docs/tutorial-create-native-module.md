...
_A tutorial on creating a native module that persists settings with Expo Modules API._
...
[Tutorial: Creating a native view](https://docs.expo.dev/modules/native-view-tutorial/)