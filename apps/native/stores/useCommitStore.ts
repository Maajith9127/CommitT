...
export const useCommitStore = create<CommitStore>((set) => ({
  commits: [
    ...
    { id: "3", title: "Study", conditions: 3, iconName: "book-open-page-variant", statusLabel: "Active" },
    ...
    { id: "10", title: "No Phone Night", conditions: 1, iconName: "cellphone-off", statusLabel: "Completed" },
  ],
