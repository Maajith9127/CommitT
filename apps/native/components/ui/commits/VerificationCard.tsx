	...
	return (
		<UView className={`mt-4 rounded-3xl ${className}`}>
			...
			<UView className="rounded-4xl bg-[#1A1A1A] px-4 pt-2 pb-4">
				...
				<UText className="mb-4 text-base text-gray-400">{description}</UText>
				...
				<UView className="flex-row items-center justify-between">
					<SecondaryButton className="mr-2 flex-1 rounded-4xl">
						Timer
					</SecondaryButton>
					<SecondaryButton className="ml-2 flex-1 rounded-4xl">
						Manual Check
					</SecondaryButton>
				</UView>
			</UView>
