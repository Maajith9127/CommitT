...
export function CommitCard({ className = "" }: Props) {
    return (
        <UView className={`bg-[#1A1A1A] rounded-3xl px-5 py-5 w-full ${className}`}>
            ...
            <DigitalCommitItem
                ...
                icons={
                    <>
                        ...
                        <FooterText className="text-blue-400 ml-1">0</FooterText>
                        ...
                        <MaterialCommunityIcons
                            ...
                            style={{ marginLeft: 12 }}
                        />
                        <FooterText className="text-blue-400 ml-1">1</FooterText>
                    </>
                }
            />
            ...
            <DigitalCommitItem
                ...
                icons={
                    <>
                        ...
                        <FooterText className="text-blue-400 ml-1">3</FooterText>
                    </>
                }
            />
                ...
                icons={
                    <>
                        <MaterialCommunityIcons
                            ...
                            color="#4FA0FF"
                        />
                        <FooterText className="text-blue-400 ml-1">2</FooterText>
                    </>
                }
            />
