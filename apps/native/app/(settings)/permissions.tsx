...
import { HeaderTitle, FooterText } from "@/components/ui/index";
...
export default function PermissionsPage() {
    ...
    const getColor = (granted: boolean) =>
        granted ? "#4FA0FF" : "#FF4D4D";
    ...
    return (
        ...
        >
            ...
            <UView className="items-center mb-10">
                ...
                <HeaderTitle className="text-3xl text-white mt-4">
                    7 Permissions Needed
                </HeaderTitle>

                <FooterText className="text-gray-400 text-center mt-3 px-4">
                    To ensure CommitT works properly, please enable these permissions.
