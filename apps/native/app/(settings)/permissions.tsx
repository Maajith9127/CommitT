	...
	return (
		...
		>
			...
			<UView className="mb-10 items-center">
				...
				<HeaderTitle className="mt-4 text-3xl text-white">
					7 Permissions Needed
				</HeaderTitle>

				<FooterText className="mt-3 px-4 text-center text-gray-400">
					To ensure CommitT works properly, please enable these permissions. We
					do not store or share any personal data.
				</FooterText>
			</UView>
